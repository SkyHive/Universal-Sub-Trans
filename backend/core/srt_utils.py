...
def save_srt(segments: List[Dict[str, Any]], output_path: str, use_translated: bool = True) -> None:
    """
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        for i, segment in enumerate(segments, 1):
            ...
            text = segment.get("translated_text") if use_translated else segment.get("text")
            if text is None:
